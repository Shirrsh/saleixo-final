  ...
  const fallbackTestimonials: Testimonial[] = [
    {
      ...
      quote: "Saleixo transformed my pottery business completely. The professional photos and e-commerce setup helped me increase sales by 300% in just 3 months.",
      rating: 5
    },
    {
      id: '2',
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto animate-fade-in animate-delay-200">
            Don't just take our word for it - hear from artisans who've transformed their businesses with Saleixo
          </p>
        </div>
