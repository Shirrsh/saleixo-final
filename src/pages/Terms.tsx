          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <p className="text-muted-foreground">
                By using Alvaio Digital Studio's services, you agree to these terms. We provide professional photography, design, and marketing services as outlined in our packages.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                For questions about these terms, contact us at hello@alvaio.com
              </p>
            </section>
          </CardContent>
        </Card>
