...
**Saleixo** (formerly "Alvaio Digital Studio") — marketing website for a full-stack ecommerce services studio, plus an admin CMS backed by Supabase. Originally scaffolded with Lovable; now maintained through Codex.
